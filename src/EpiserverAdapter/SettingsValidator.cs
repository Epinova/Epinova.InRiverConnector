...
namespace Epinova.InRiverConnector.EpiserverAdapter
{
    public class SettingsValidator
    {
        ...
        public void ValidateSettings()
        {
            ...
            {
                if (!Boolean.TryParse(_settings[ConfigKeys.ForceIncludeLinkedContent], out bool _))
            ...
            if (!SettingHasValue("EPI_ENDPOINT_URL"))
            {
                throw new ConfigurationErrorsException(
                    "Missing EPI_ENDPOINT_URL setting on connector. It should point to the import end point on the EPiServer Commerce web site. Please see the documentation.");
            }
        ...
        private static void ValidateEndpointAddress(string address)
        {
            if (String.IsNullOrEmpty(address))
            {
                throw new ConfigurationErrorsException(
                    "Missing ImportEndPointAddress setting on connector. It should point to the import end point on the EPiServer Commerce web site. Please see the documentation.");
            }
