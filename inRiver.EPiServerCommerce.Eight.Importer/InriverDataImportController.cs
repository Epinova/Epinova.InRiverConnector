...
namespace inRiver.EPiServerCommerce.Eight.Importer
{
    ...
    using inRiver.EPiServerCommerce.Eight.Importer.ResourceModels;
    ...
    public class InriverDataImportController : SecuredApiController
    {
                ...
                () =>
                    {
                        try
                        {
                            ...
                            {
                                this.ImportCatalogXmlWithHandlers(catalogXmlStream, catalogImportHandlers);
                            }
                            else
                            {
        ...
        [HttpPost]
        public bool ImportResources(List<IInRiverImportResource> resources)
        {
            if (resources == null)
            {
            ...
            Log.DebugFormat("Received list of {0} resources to import", resources.Count());
        ...
        private void ImportCatalogXmlWithHandlers(Stream catalogXml, List<ICatalogImportHandler> catalogImportHandlers)
        {
        ...
        private void ImportImageAndAttachToEntry(IInRiverImportResource inriverResource)
        {
            ...
            try
            {
                if (existingMediaData != null)
                {
                    ...
                    {
                        this.AddLinksFromMediaToCodes(existingMediaData, null);
                    }
        ...
        protected void AddOrUpdateMediaOnEntry(EntryCode entryCode, ContentReference linkToContent, CommerceMedia media)
        {
            ...
            IContentRepository contentRepository = _contentRepository.Service;
            ContentReference link = _referenceConverter.Service.GetContentLink(entryCode.Code);
            ...
            if (contentData != null)
            {
                ...
                if (assetContainer != null)
                {
                    ...
                    else
                    {
                        ...
                        {
                            writableClone = SetSortOrderOnMedia(contentData, linkToContent, 0);
                        }
                        else if (entryCode.IsMainPicture == false && existingMedia.SortOrder == 0)
                        {
                            ...
                            writableClone = SetSortOrderOnMedia(contentData, linkToContent, 1);
                        }
                    }
                    ...
                    if (writableClone != null)
                    {
                        ...
                        _contentRepository.Service.Save(writableClone, saveAction, AccessLevel.NoAccess);
                    }
                }
            }
        }
        ...
        {
            PermanentContentLinkMap permanentContentLinkMap = _permanentLinkMapper.Service.Find(assetId) as PermanentContentLinkMap;
